...
export default class PopoverMenu_Renderer extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    let { position, placement, offset } = computeProperties(layouts, userPlacement, preferredPlacement, isRTL);
    ...
    const animation = {
      transform: [
        ...
        // { translateY: Animated.multiply(position.top, this.state.scaleAnim) },
      ],
...
PopoverMenu_Renderer.propTypes = {
...
PopoverMenu_Renderer.defaultProps = {
